...
if ($pessoa == "FuncAdm") {
    ...
    echo "<head>";
        ...
        echo " <link rel='stylesheet' href='exibir.css' />";
    echo "</head>";
    echo "<body>";
        echo "<div id='header'>";
             echo "<h1 id='h1' align='center'> Administrativo</h1>";
         echo "</div>";
    echo "<div id='content'>";
    echo "<fieldset>";
    ...
    echo "<body>";
    echo "<div id='header'>";
        echo "<h1 id='h1' align='center'>Professor</h1>";
    echo "</div>";
    echo "<div id='content'>";
    echo "<fieldset>";
            echo "<form id='formulario' method='post' action='exibir.php'>";
    ...
    echo "<body>";
    echo "<div id='header'>";
        echo "<h1 id='h1' align='center'>Aluno</h1>";
    echo "</div>";
    echo "<div id='content'>";
    echo "<fieldset>";
    echo "<form id='formulario' method='post' action='exibir.php'>";
